...
def symbol_for_equipment(kind: str) -> str | None:
    ...
    aliases = {
        "POSTE_CIRCULAR_CONCRETO": "POSTE_CONCRETO",
        "POSTE_CONCRETO": "POSTE_CONCRETO",
        "POSTE_CIRCULAR_MADEIRA": "POSTE_MADEIRA",
        "POSTE_MADEIRA": "POSTE_MADEIRA",
        "POSTE_MADEIRA_COM_ESTAI": "POSTE_MADEIRA",
        "POSTE_DUPLO_T": "POSTE_DUPLO_T",
        "POSTE_SUBSTITUIR": "POSTE_NOVO",
        "TRANSFORMADOR_COM_PARA_RAIO": "TRANSFORMADOR_RGE",
        "CHAVE_FUSIVEL_COM_PARA_RAIO": "CHAVE_FUSIVEL_SEM_ABERTURA_CARGA",
